...
import com.ervaergul.BookstoreBackend.Exception.ConflictedUpdateException;
import com.ervaergul.BookstoreBackend.Exception.EntityAlreadyExistsException;
...
public class BookService {
    ...
    public String createBook(BookDTO bookDTO) {
        ...
        return newBook.getName() + " by " + newBook.getAuthor() + " is now being sold";
    }
    ...
    public List<Book> findByType(String type) {
        ...
        if(books.isEmpty()) {
            throw new EntityNotFoundException("There are no " + type + " books");
        }
        return books;
    }
    ...
    public String setPrice(Long id, Long newValue) {
        ...
        if(bookToUpdate.getPrice() == newValue) {
    ...
    public String setStock(Long id, Long newValue) {
        ...
        if(bookToUpdate.getStock() == newValue) {
